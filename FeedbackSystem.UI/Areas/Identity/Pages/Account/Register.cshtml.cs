...
namespace FeedbackSystem.UI.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            try
            {
                if (!_roleManager.RoleExistsAsync(UserRole.Role_User_User).GetAwaiter().GetResult())
                {
                    _roleManager.CreateAsync(new IdentityRole(UserRole.Role_User_User)).GetAwaiter().GetResult();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.UserRole = UserRole.Role_User_User;
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, UserRole.Role_User_User);
